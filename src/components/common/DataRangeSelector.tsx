        ...
        <div className="relative"
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <div
                        className={`px-3 py-1 rounded-md ${isOpen && activeSelector === 'start' ? 'bg-primary-100' : ''}`}
                        onClick={() => setActiveSelector('start')}>
                        {formatDate(startDate)}
                    </div>
                    <span className="text-gray-400">→</span>
                    <div
                        className={`px-3 py-1 rounded-md ${isOpen && activeSelector === 'end' ? 'bg-primary-100' : ''}`}
                    ...
                    >
                        ...
                        <div className="grid grid-cols-7 gap-1">
                            <AnimatePresence mode='popLayout'>
                                ...
                                {getDaysInMonth(currentMonth).map((date, ind) => {
